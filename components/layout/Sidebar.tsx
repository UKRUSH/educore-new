...
const NAV: Record<string, NavItem[]> = {
  ...
  ADMIN: [
    ...
    { label: "Applications", href: "/admin/club-applications", icon: ICONS.settings  },
    { label: "Mentors",      href: "/admin/mentors",           icon: ICONS.support   },
  ],
  LECTURER: [
...
const ROLE_META: Record<string, { label: string; color: string; bg: string; dot: string }> = {
  ADMIN:    { label: "Admin",    color: "#f87171", bg: "rgba(239,68,68,.18)",   dot: "#f87171" },
  LECTURER: { label: "Lecturer", color: "#c084fc", bg: "rgba(168,85,247,.18)", dot: "#c084fc" },
  STUDENT:  { label: "Student",  color: "#93c5fd", bg: "rgba(96,165,250,.18)", dot: "#93c5fd" },
}

export default function Sidebar({ role, name, photoUrl }: { role: string; name: string; photoUrl: string | null }) {
    ...
    <>
      <style>{`
        ...
        .sb-section-label {
          ...
          padding: .65rem .65rem .28rem; margin-top: .2rem;
        }
        ...
        .sb-item {
          position: relative;
          display: flex; align-items: center; gap: .7rem;
          padding: .58rem .7rem; border-radius: .75rem;
          text-decoration: none;
          font-size: .845rem; font-weight: 500;
          color: var(--sidebar-foreground,#555);
          transition: all .17s ease;
          border: 1px solid transparent;
          overflow: hidden;
        }
        .sb-item:hover {
          background: var(--sidebar-accent,#f3f4f6);
          color: var(--foreground,#090909);
          border-color: var(--sidebar-border,#e5e7eb);
        ...
        .sb-item.active {
          ...
          border-color: oklch(0.6231 0.1880 259.8145 / .22);
          font-weight: 700;
        }
        /* left accent bar */
        ...
        .sb-icon {
          ...
          display: flex; align-items: center; justify-content: center;
          background: transparent; transition: all .17s ease;
        ...
        .sb-item.active .sb-icon {
          ...
          box-shadow: 0 4px 12px oklch(0.4882 0.2172 264.3763 / .35);
          color: #fff;
        }
        ...
        .sb-logout {
          ...
          color: var(--sidebar-foreground,#555);
          transition: all .17s ease; text-align: left;
        }
        .sb-logout:hover {
      ...
      <aside className="sb-root">
        ...
        <nav className="sb-nav">
          ...
          <Link href="/settings" className={`sb-item${pathname.startsWith("/settings") ? " active" : ""}`}>
